...
const Button = ({ children, variant = "primary", className = "", onClick, icon: Icon }: any) => {
  const baseStyle = "relative px-6 py-3 font-orbitron font-bold text-sm uppercase tracking-wider transition-all duration-300 clip-path-slant flex items-center justify-center gap-2";
  const variants = {
